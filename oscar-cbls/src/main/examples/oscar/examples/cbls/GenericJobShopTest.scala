...
//import oscar.visual.scheduling.VisualGanttChart // todo: ask renaud to make visual gantt chart and profile independent of CP such that it can move into visual

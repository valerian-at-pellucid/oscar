...
import scampi.cp.constraints.Opposite;
...
public class CPVarInt implements Iterator<Integer>, Iterable<Integer>{
     ...
     * @param c
     * @see scampi.cp.core.Constraint#propagate()
     */
     ...
     * the domain of the variable is a singleton (i.e. isBound()).
     * @param c
     * @see scampi.cp.core.Constraint#valBind(CPVarInt)
     */
     ...
     * @param c
     * @see scampi.cp.core.Constraint#updateBounds(CPVarInt)
     */
     ...
     * @param c
     * @see scampi.cp.core.Constraint#updateMax(CPVarInt, int)
     */
     ...
     * @param c
     * @see scampi.cp.core.Constraint#updateMin(CPVarInt, int)
     */
     ...
     * @param c
     * @see scampi.cp.core.Constraint#valRemove(CPVarInt, int)
     */
